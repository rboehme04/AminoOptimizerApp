...
2. For each selected food, create one recipe variant. The food must be added or replace an existing ingredient. Adjust other ingredient quantities to maintain taste, consistency, and balance.
