...
1. Select exactly 12 foods from the recommended foods list that fit the flavor, improve or maintain texture, and realistically work in the recipe. Exclude foods that clearly do not fit (e.g., meat/fish in sweet vegan recipes).
...
Do not include any extra text, explanations, numbering, or comments. Only output valid JSON.
