...
export const generateText = async (
  ...
  try {
    // For conversational models, use the conversational endpoint via direct API call
    // Extract the user's prompt (last user message) - simple prompt/answer flow
    ...
    // Simple prompt/answer - no conversation history needed
    // Use direct API call to conversational endpoint via router
    ...
    // Extract the generated text from conversational response
