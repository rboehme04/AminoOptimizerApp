...
1. Select exactly ${} foods from the recommended foods list that fit the flavor, improve or maintain texture, and realistically work in the recipe. Exclude foods that clearly do not fit (e.g., meat/fish in sweet vegan recipes).
