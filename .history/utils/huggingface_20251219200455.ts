...
export const generateText = async (
  ...
  // Try router API with chat completions endpoint first
  // If that doesn't work, fall back to direct model endpoint
  const url = `${HF_API_BASE}/chat/completions`;

  // Try OpenAI-compatible chat format first (router API may support this)
  const requestBody = {
    model: model,
  ...
  // Handle legacy inference API format
