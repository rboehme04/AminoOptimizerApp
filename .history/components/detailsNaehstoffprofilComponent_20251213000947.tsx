  ...
  rows = [
    {
      title: "Überblick",
      values: [
        { label: "Energie (kcal)", current: 378, reference: 1950, measuringUnit: "kcal" },
        { label: "Fett", current: 10, reference: 63, measuringUnit: "g" },
        { label: "Eiweiß", current: 40, reference: 89, measuringUnit: "g" },
        { label: "Kohlenhydrate", current: 59, reference: 283, measuringUnit: "g" },
        { label: "Ballaststoffe", current: 9, reference: 33, measuringUnit: "g" },
        { label: "Salz", current: 0.09, reference: 5, measuringUnit: "g" },
        { label: "Wasser", current: 1, reference: 2500, measuringUnit: "ml" },
