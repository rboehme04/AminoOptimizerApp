  ...
  rows = [
    {
      title: "Überblick",
      values: [
        { label: "Energie (kcal)", current: 378, reference: 1950 },
        { label: "Fett", current: 10, reference: 63 },
        { label: "Eiweiß", current: 40, reference: 89 },
        { label: "Kohlenhydrate", current: 59, reference: 283},
        { label: "Ballaststoffe", current: 9, reference: 33 },
        { label: "Salz", current: 0.09, reference: 5 },
        { label: "Wasser", current: 1, reference: 2500 },
        { label: "Alkohol", current: 10, reference: 50 },
      ],
      icon: Lion3dIcon,
    },
    {
