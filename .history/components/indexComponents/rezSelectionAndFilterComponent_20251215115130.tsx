...
const RezSelectionAndFilterComponent = (
  ...
  // Respect the provided activeSide even on optimizer home; default to Rezept only
  // when no side is supplied.
  const effectiveActiveSide = props.activeSide ?? "Rezept";
