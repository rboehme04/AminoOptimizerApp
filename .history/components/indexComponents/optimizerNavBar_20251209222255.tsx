...
const BAOptNavBar = ({ isBold = false }: BAOptNavBarProps) => {
    ...
    <SafeAreaView edges={["left", "right"]}>
      <View style={[styles.view, styles.viewFlexBox]}>
        <View style={styles.viewFlexBox}>
          <Pressable style={[styles.clickContainer, styles.clickContainerFlexBox]} onPress={() => {}}>
            <ChevronLeftIcon size={28} />
          </Pressable>
        </View>
        <Text style={[styles.optimizer, isBold ? Typography.title2Emphasized : Typography.title2Regular]}>Optimizer</Text>
        <View style={styles.viewFlexBox}>
          <Pressable
