...
const LebensmittelRow = () => {
  	...
  	return (
    		<SafeAreaView style={styles.lebensmittelRow}>
      			<View style={[styles.view, styles.viewFlexBox]}>
        				<Pressable style={[styles.leftClickContainer, styles.frameFlexBox]} onPress={()=>{}}>
          					<Text style={styles.title}>Apfel (mit Schale), frisch</Text>
          					<View style={[styles.bottomContainer, styles.containerFlexBox]}>
            						<View style={[styles.frame, styles.frameFlexBox]}>
              							...
              							<Text style={[styles.fruchtMittelgro, styles.kcalTypo]}>1 Frucht, mittelgroß</Text>
            						</View>
            						<View style={[styles.frame, styles.frameFlexBox]}>
              							<View style={styles.eatSymbol}>
                								<Image style={[styles.vectorIcon2, styles.vectorIconLayout]} resizeMode="cover" />
              							</View>
              							<Text style={styles.kcalTypo}>52kcal</Text>
            						</View>
          					</View>
        				</Pressable>
