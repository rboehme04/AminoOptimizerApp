...
const ZutatenContainer = () => {
  return (
    <View style={styles.zutatenContainer}>
      <View style={styles.view}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.container}>
            <View
              style={[styles.rezeptErstellenLebensmittel, styles.buttonFlexBox]}
            >
              <View style={styles.container2}>
                ...
                <View style={styles.headerContainer}>
                  <Text
                    style={[styles.fruchtMittelgro150g, styles.zutatenFlexBox]}
                  >
                    1 Frucht, mittelgroß (150g)
                  </Text>
                </View>
              </View>
              <View style={[styles.container5, styles.buttonFlexBox]}>
                ...
                <View style={[styles.clickContainer, styles.buttonIconFlexBox]}>
                  <Pressable
                    style={[styles.buttonIcon, styles.buttonIconFlexBox]}
                  >
            ...
            >
              <View style={styles.container2}>
                <View style={styles.headerContainer}>
                  <Text style={[styles.banane, styles.kcalTypo]}>
                    Haferflocken
                  </Text>
                </View>
                <View style={styles.headerContainer}>
          ...
          >
            ...
            <View style={styles.container17}>
              <Text style={[styles.hinzufgen, styles.hinzufgenFlexBox]}>
                Hinzufügen
              </Text>
            </View>
          </Pressable>
