      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.buttonRowContainer}>
            <Pressable style={[styles.buttonOuterContainer, styles.leftButtonContainer]} onPress={() => {}}>
              <View style={styles.button}>
                <Text style={styles.buttonText}>Entfernen</Text>
              </View>
            </Pressable>
            <Pressable style={[styles.buttonOuterContainer, styles.rightButtonContainer]} onPress={() => {}}>
              <View style={styles.button}>
