...
const ValueRowContainer = ({
  ...
  if (
    ...
    const cs = currentPer100gProtein;
    // percentage = Math.round(cs);
    percentage = cs;
    console.log("factor", proteinFactor, "proteinPer100g", proteinPer100g, "current", current, "currentPer100gProtein", currentPer100gProtein, "cs", cs);
  }
