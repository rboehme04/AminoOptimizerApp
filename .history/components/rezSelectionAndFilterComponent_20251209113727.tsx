              ...
              {isFavoriten ? (
                <>
                  <Path
                    ...
                    clipRule="evenodd"
                    d={starFullPath1}
                    fill={Color.neutralInputOnDark}
                  />
                  <Path d={starFullPath2} fill={Color.neutralInputOnDark} />
                </>
              ) : (
                <Path
                  fillRule="evenodd"
          ...
          >
            <Svg width={16} height={16} viewBox="0 0 16 16" fill="none">
              <Path
                ...
                d={starPath}
                fill={
                  isFavoriten ? Color.neutralInputOnDark : Color.neutralWhite
                }
              />
            </Svg>
            <Text
