...
const RecipeDetailTopComponent = ({
  ...
  const Container = isPicture ? ImageBackground : View;
  const containerProps = isPicture
    ? { source: breakfastImage, resizeMode: "cover" as const }
    : {};
  ...
  return (
    <Container
      ...
      style={[
        ...
        !isPicture && styles.imageBackgroundNoPicture,
      ]}
    >
      <LinearGradient
        colors={
        ...
        style={[
          ...
          !isPicture && styles.overlayNoPicture,
        ]}
      >
        <NavBar title="Hinzufügen" rightActions={rightActions} />
        <View style={[styles.content, !isPicture && styles.contentNoPicture]}>
          <View
            style={[
              styles.titleContainer,
              !isPicture && styles.titleContainerNoPicture,
            ]}
          >
            <Text
