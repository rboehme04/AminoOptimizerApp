...
interface LeftRightToggleProps {
  ...
  inactiveColor?: string; // Label color for the inactive side
}
...
const LeftRightToggle = ({
  ...
  inactiveColor = Color.neutralButtonInactive,
}: LeftRightToggleProps) => {
  // Use controlled value if provided, otherwise use internal state
  const isControlled = value !== undefined;
  const [internalActiveSide, setInternalActiveSide] = React.useState<
    "left" | "right"
  >(initialValue);
