        ...
        if (answer) {
          ...
          try {
            ...
            try {
              ...
              console.log("JSON.parse failed, trying to extract objects. Error:", parseError);
              ...
              try {
                ...
                if (Array.isArray(parsed)) {
                  ...
                  console.log("Successfully parsed as wrapped array, found", parsedVariants.length, "variants");
                }
              } catch (wrapError) {
                console.log("Wrapping in array failed, trying to extract individual objects");
                ...
                const extractCompleteObjects = (text: string): Variant[] => {
                    ...
                    if (text[i] === "{") {
                      ...
                      if (depth === 0 && start !== -1) {
                        ...
                        try {
                          ...
                          console.log("Failed to parse object:", objStr.substring(0, 100), parseErr);
                          // Skip invalid JSON
                        }
                        start = -1;
                      }
                  ...
                  console.log("extractCompleteObjects found", results.length, "objects");
                  return results;
                };
