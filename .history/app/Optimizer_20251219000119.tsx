    ...
    <SafeAreaView style={styles.Content}>
      ...
      {showPopup && (
        <OptimizerPopUp
          ...
          descriptionText={`Optimiere die Zubereitung und Zutaten, um die Aufnahme von Vitaminen und Mineralstoffen zu verbessern \n\n Die Empfehlungen basieren auf dem Vitamingehalt und sind nach der erwarteten Wirkung auf die Nährstoff-Bioverfügbarkeit sortiert.`}
          isShowButtons={true}
