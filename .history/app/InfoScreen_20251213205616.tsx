  ...
  return (
    <SafeAreaView>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoParagraphContainer}>
          <Text style={styles.infoParagraphTitle}>Der Chemical Score</Text>
          <Text style={styles.infoParagraphTitle}>
          Der Chemical Score (WHO-Standard) zeigt, wie gut dein Körper das Protein verwerten kann. Je höher, desto besser.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
