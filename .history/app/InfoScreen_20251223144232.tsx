...
const INFO_SECTIONS = [
  ...
  },
  {
    ...
    content:
      "Der Amino Acid Score zeigt, wie gut dein Körper das Protein verwerten kann. Er wird ermittelt, indem man prüft, welche essenzielle Aminosäure im Verhältnis zum WHO-Referenzwert am knappsten vorhanden ist – diese limitierende Aminosäure bestimmt den Score. Je höher der Wert, desto mehr Protein kann dein Körper verwerten.",
  },
];
