    ...
    <Svg width={width} height={height}>
      <G x={margin.left} y={margin.top}>
        {data.map((d, i) => {
          ...
          const usableHeight = chartHeight - yScale(d.usable);
          const unusableHeight = chartHeight - yScale(total) - usableHeight;
          
          // Calculate y positions
          const usableY = yScale(total);
          const unusableY = yScale(d.usable);
