      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.headerButtonsContainer}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.oderAuswaehlenText}>oder auswählen:oder auswählen:oder auswählen:oder auswählen:oder auswählen:oder auswählen:oder auswählen:oder auswählen:oder auswählen:oder auswählen:</Text>
          </View>
        </View>
      </View>
