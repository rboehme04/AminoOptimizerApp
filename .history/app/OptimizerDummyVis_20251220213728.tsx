...
const StackedBarChart = ({ 
  ...
  const maxValue = Math.max(
    ...data.map(d => d.usable + d.unusable)
  );
    ...
    <Svg width={width} height={height}>
      <G x={margin.left} y={margin.top}>
        {data.map((d, i) => {
          ...
          // Calculate y positions (in SVG, y=0 is at top)
          const usableY = yScale(total); // Bottom of usable segment
          const unusableY = yScale(d.usable); // Bottom of unusable segment (top of usable)
          
          // Calculate heights
          const usableHeight = chartHeight - usableY;
          const unusableHeight = usableY - unusableY;
            ...
            <View style={styles.aminoOptBarChartContainer}>
              ...
              <View style={styles.legendContainer}>
                <View style={styles.legendeRow}>
                    <View style={[styles.legendeColorBox, { backgroundColor: Color.success70 }]} />
                    <Text style={styles.legendeText}>Nutzbar für Muskeln, Zellen, Enzyme & Immunsystem</Text>
                </View>
                <View style={styles.legendeRow}>
                    <View style={[styles.legendeColorBox, { backgroundColor: Color.neutralButtonInactive }]} />
                    <Text style={styles.legendeText}>Nicht nutzbar, wird nur zur Energiegewinnung verwendet</Text>
                </View>
              </View>
            </View>
          </View>
