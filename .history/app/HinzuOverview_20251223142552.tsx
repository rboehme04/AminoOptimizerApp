  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      if (!isFirstFocus.current) {
        // Dismiss keyboard and blur immediately when returning to screen (before render)
        Keyboard.dismiss();
        // Use requestAnimationFrame to ensure blur happens synchronously before render
