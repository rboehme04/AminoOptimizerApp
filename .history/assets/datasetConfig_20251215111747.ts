...
export const nutrientReferences: NutrientReferenceGroup[] = [
  ...
  },
  {
    title: "Vitamine",
    values: [
      { label: "Vitamin A", reference: 0, measuringUnit: "µg", column: "vitamin_a" },
      { label: "Vitamin A (IU)", reference: 0, measuringUnit: "IU", column: "vitamin_a_iu" },
      { label: "Vitamin B6", reference: 0, measuringUnit: "mg", column: "vitamin_b6" },
      { label: "Vitamin B12", reference: 0, measuringUnit: "µg", column: "vitamin_b12" },
      { label: "Vitamin C", reference: 0, measuringUnit: "mg", column: "vitamin_c" },
      { label: "Vitamin D", reference: 0, measuringUnit: "µg", column: "vitamin_d" },
      { label: "Vitamin D3", reference: 0, measuringUnit: "µg", column: "vitamin_d3" },
      { label: "Vitamin D (IU)", reference: 0, measuringUnit: "IU", column: "vitamin_d_iu" },
      { label: "Vitamin E", reference: 0, measuringUnit: "mg", column: "vitamin_e" },
      { label: "Vitamin E Alpha", reference: 0, measuringUnit: "mg", column: "vitamin_e_alpha" },
      { label: "Vitamin K", reference: 0, measuringUnit: "µg", column: "vitamin_k" },
      { label: "Thiamin", reference: 0, measuringUnit: "mg", column: "thiamin" },
      { label: "Riboflavin", reference: 0, measuringUnit: "mg", column: "riboflavin" },
      { label: "Niacin", reference: 0, measuringUnit: "mg", column: "niacin" },
      { label: "Pantothensäure", reference: 0, measuringUnit: "mg", column: "pantothenic_acid" },
      { label: "Biotin", reference: 0, measuringUnit: "µg", column: "biotin" },
      { label: "Folsäure", reference: 0, measuringUnit: "µg", column: "folic_acid" },
      { label: "Folat (DFE)", reference: 0, measuringUnit: "µg", column: "folate_dfe" },
      { label: "Gesamtfolat", reference: 0, measuringUnit: "µg", column: "total_folate" },
    ],
    icon: RedApple3dIcon,
  },
  {
    ...
    values: [
      { label: "Calcium", reference: 0, measuringUnit: "mg", column: "calcium" },
      { label: "Chlorid", reference: 0, measuringUnit: "mg", column: "chlorine" },
      { label: "Magnesium", reference: 0, measuringUnit: "mg", column: "magnesium" },
      { label: "Phosphor", reference: 0, measuringUnit: "mg", column: "phosphorus" },
      { label: "Kalium", reference: 0, measuringUnit: "mg", column: "potassium" },
      { label: "Natrium", reference: 0, measuringUnit: "mg", column: "sodium" },
    ],
    icon: Broccoli3dIcon,
  },
  {
    ...
    values: [
      { label: "Chrom", reference: 0, measuringUnit: "µg", column: "chromium" },
      { label: "Kupfer", reference: 0, measuringUnit: "mg", column: "copper" },
      { label: "Iod", reference: 0, measuringUnit: "µg", column: "iodine" },
      { label: "Eisen", reference: 0, measuringUnit: "mg", column: "iron" },
      { label: "Mangan", reference: 0, measuringUnit: "mg", column: "manganese" },
      { label: "Molybdän", reference: 0, measuringUnit: "µg", column: "molybdenum" },
      { label: "Selen", reference: 0, measuringUnit: "µg", column: "selenium" },
      { label: "Zink", reference: 0, measuringUnit: "mg", column: "zinc" },
    ],
    icon: Peach3dIcon,
  },
  {
  ...
  },
  {
    ...
    values: [
      ...
      { label: "Einfach ungesättigte Fettsäuren", reference: 0, measuringUnit: "g", column: "monounsaturated_fats" },
      { label: "Mehrfach ungesättigte Fettsäuren", reference: 0, measuringUnit: "g", column: "polyunsaturated_fats" },
      ...
      { label: "Dihomo-Gamma-Linolensäure", reference: 0, measuringUnit: "g", column: "dihomo_gamma_linolenic_acid" },
      { label: "Docosahexaensäure (DHA)", reference: 0, measuringUnit: "g", column: "docosahexaenoic_acid" },
      { label: "Docosapentaensäure (DPA)", reference: 0, measuringUnit: "g", column: "docosapentaenoic_acid" },
      { label: "Eicosapentaensäure (EPA)", reference: 0, measuringUnit: "g", column: "eicosapentaenoic_acid" },
  ...
  },
  {
    ...
    values: [
      { label: "Koffein", reference: 0, measuringUnit: "mg", column: "caffeine" },
      { label: "Nicht zugeordnet", reference: 0, measuringUnit: "-", column: "undefined" },
    ],
    icon: Grapes3dIcon,
  },
];
