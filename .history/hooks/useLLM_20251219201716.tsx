 ...
 * 3. Add EXPO_PUBLIC_HF_TOKEN to your .env file or environment variables
 *
...
export const useLLM = (): UseLLMReturn => {
  ...
  const callLLM = useCallback(async (prompt: string, systemPrompt?: string) => {
    ...
    try {
      ...
      if (!apiKey) {
        throw new Error(
          "Hugging Face API key not found. Please set EXPO_PUBLIC_HF_TOKEN in your environment variables."
        );
      }
