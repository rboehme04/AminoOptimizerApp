...
export const createPrompt = ({
  ...
  // Build the prompt
  const generatedPrompt = `You are a professional nutritionist and recipe developer specialized in high-protein, plant-based recipes with excellent taste and texture.
