  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        ...
        <SettingsRowComponent text="Gutschein Einlösen" onPress={() => {}} isChevron={false} />
        <SettingsRowComponent text="Daten zurücksetzen" onPress={() => {}} color={Color.brand40LetzteButtonOrBlueText} isChevron={false} />
        <SettingsRowComponent text="Account löschen" onPress={() => {}} color={Color.brand40LetzteButtonOrBlueText} isChevron={false} />
        <SettingsRowComponent text="Abmelden" onPress={() => {}} color={Color.brand40LetzteButtonOrBlueText} isChevron={false} />
      </View>
    </View>
  );
}
